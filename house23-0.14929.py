...
model.add(Dense(39*4,input_shape=(X_train.shape[1],),activation='relu'))
model.add(Dense(39*2,activation='relu'))
...
# for i in range(15):
model.fit(X_train,y_train,batch_size=X_train.shape[0],epochs=1500,verbose=1)
